...
void WFG9::evaluate (vector<double> &X, vector<double> &Obj) {
...
vector< double > WFG9::WFG_normalise_z( const vector< double >& z )
{
  vector< double > result;
