...
void WFG4::evaluate (vector<double> &X, vector<double> &Obj) {
...
vector< double > WFG4::WFG_normalise_z( const vector< double >& z )
{
  vector< double > result;
